...
contract YECCOIN is StandardToken {
  function () {
  ...
  */
  string public name = &#39;YECCOIN&#39;;          //fancy name: eg Simon Bucks
  ...
  string public symbol = &#39;YEC&#39;;         //An identifier: eg SBX
...
//make sure this function name matches the contract name above. So if you&#39;re token is called TutorialToken, make sure the //contract name above is also TutorialToken instead of ERC20Token
  function YECCOIN(
    ...
    name = &quot;YEC Coin&quot;;              // Set the name for display purposes
    decimals = 0;                 // Amount of decimals for display purposes
    symbol = &quot;YEC&quot;;                // Set the symbol for display purposes
  }
